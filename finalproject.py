...
Original file is located at
    https://colab.research.google.com/drive/1yqE5ujq0WXI3H9rXqv7RAnnO2624QXfO
"""
...
def set_page_config():
    st.set_page_config(
        page_title="",
        page_icon="https://png.pngtree.com/element_our/20200609/ourmid/pngtree-data-analysis-bar-chart-image_2226670.jpg",
        layout="wide",
        initial_sidebar_state="expanded",
        menu_items={'About': """# This OCR is created by *Nitish*©"""}
    )
...
def setting_bg():
    st.markdown(
        ...
        <style>
            .stApp {
                background: url("https://t4.ftcdn.net/jpg/01/70/93/27/360_F_170932733_VOHGeaH5AjrVCXBVryEwVgwhArv2wNNH.jpg");
...
if selected == "PRODUCT RECOMMENDATION-SYSTEM":
    ...
    data = pd.read_csv("/content/amazon_product.csv")
  ...
  # --MY progile-- #
if selected == "PROFILE":
    st.subheader(":red[DTM 12 FINAL PROJECT]",divider='rainbow')
    ...
    with col1:
        ...
        for _ in range(3):
            st.write(" ")
        st.markdown("### :orange[Name:  ] :blue[NitishKumar]")
        st.markdown("### :black[GitHub] ⬇️")
        github_url = "https://github.com/Nitishkumar-8"
        button_color = "#781734"
    ...
    with col2:
        ...
        for _ in range(3):
            st.write(" ")
        st.markdown("### :orange[Email: nitish1978053@gmail.com] ")
        st.markdown("### :orange[LinkedIn] ⬇️")
        linkedin_url = "https://www.linkedin.com/in/nitish-kumar-a-462869145?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
        button_color = "#781734"
